...
if __name__ == '__main__':
    ...
    G.add_nodes_from([
        ...
        ("v:1.25:3.17", {"label": "v", "x": 1.25, "y": 3.17, "h": 1}),  # Hanging node on bottom edge
    ])
    ...
    G.add_edges_from([
        ...
        ("v:7.5:1.34", "v:10.0:5.0", {"label": "E", "B": 1}),

        # Hanging node connections
        ("v:5.0:8.66", "v:7.5:8.66", {"label": "E", "B": 1}),
        ("v:2.5:8.66", "v:5.0:8.66", {"label": "E", "B": 1}),
        ("v:2.5:1.34", "v:1.25:3.17", {"label": "E", "B": 1}),
        ("v:1.25:3.17", "v:0.0:5.0", {"label": "E", "B": 1}),
